      ...
      <article class="article">
        <div class="middle">
          <div class="el_table">
            ...
            <el-pagination class="el_page" @size-change="handleSizeChange" @current-change="handleCurrentChange"
              :current-page="currentPage" :background="background" :page-sizes="[5, 10, 20, 30, 3000]"
...
.voxel-type-selector {
  ...
  :deep(.el-radio-button) {
    ...
    .el-radio-button__inner {
      padding: 8px 15px;
      color: white;
      background-color: rgba(50, 69, 139, 0.7);
      border: none;
    }
  }
}
