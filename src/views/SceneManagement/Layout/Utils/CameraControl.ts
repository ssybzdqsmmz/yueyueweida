 ...
 * @LastEditors: 枫林残忆
 * @LastEditTime: 2024-03-07 11:41:06
 * @FilePath: \Geology-V3\src\views\SceneManagement\Layout\Utils\CameraControl.ts
...
function getCameraViewportForServer(viewer) {
  let viewport = {
    Position: {},
    Orientation: {},
  };
  let res = getCameraViewPoint(viewer);
  viewport.Position = res.Position;
  viewport.Orientation = res.Orientation;
  return viewport;
}

export { disableCamera, enableCamera, windowShake, setCameraViewPoint, getCameraViewPoint, getCameraViewportForServer };
