<template>
  <div class="right" :class="{ collapsed: isTableCollapsed }" :style="rightStyle" ref="panelRef">
    <div class="panel-header" @mousedown="onDragMouseDown">
      <span>断裂带详细信息</span>
    </div>
    <div class="constructionInfo">
      <el-table :data="construction" style="width: 100%" height="240px">
        <el-table-column prop="attribute" label="属性" width="160" align="center" />
...
const updateTables = (faultInfo) => {
  construction.value = [
    { attribute: '断裂名称', information: faultInfo.fault_ch },
    { attribute: '断裂宽度（m）', information: faultInfo.fault_wide },
    { attribute: '断层面倾角（°）', information: faultInfo.faultplanedip },
    { attribute: '断层线走向（°）', information: faultInfo.faultlineorientation },
    { attribute: '断裂性质', information: faultInfo.natureoffracture },
  ];
};
...
:deep(.el-table__body tr) {
  border-bottom: 1px solid rgb(186 243 255 / 10%) !important;
}
</style>
